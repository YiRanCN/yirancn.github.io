...
#### git-commit-id-plugin
 ...
 - [CSDN-Maven学习笔记 - git-commit-id-plugin插件](https://blog.csdn.net/mytt_10566/article/details/100116670)

#### jacoco-maven-plugin

在Maven项目中，我们可以使用jacoco-maven-plugin插件来生成代码覆盖率报告。Jacoco是一种用于测量代码覆盖率的工具，它能够生成覆盖率数据并帮助我们找出代码中未被测试的部分。

[使用Maven插件（jacoco-maven-plugin）生成代码覆盖率报告](https://developer.baidu.com/article/details/2778816)